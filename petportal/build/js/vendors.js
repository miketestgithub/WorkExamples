...
(function (root, factory) {
	...
	function fill (target) {
		...
		for (var i = 0; i < options.calendars; i++) {
			...
			dom_query(instance, '.pmu-month span').textContent = header;
			...
			(function () {
				...
				for (month = 0; month < 12; ++month) {
					...
					month_element.textContent      = options.locales[options.locale].months[month];
	...
	pickmeup_init.defaults = {
		...
		instance_template         : function (options) {
			...
			return '<div class="pmu-instance">' +
				...
				'<div class="pmu-month pmu-button"><span class="pmu-month-name"></span><span class="pmu-year-name"></span></div>' +
                '<div class="pmu-next pmu-button">' + options.next + '</div>' +
                '<button class="j-skip pmu-button">' + 'Skip days' + '</button>' +                
				'</nav>' +
